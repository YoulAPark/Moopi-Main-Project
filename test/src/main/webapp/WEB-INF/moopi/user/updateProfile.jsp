...
// [완료] by. 율아
// 마이홈 - 프로필수정
// 수정type : 3)닉네임, 4)프로필소개, 5)주소, 6)관심사1/2/3
function edit(type){
		...
		// "type==5" : fullAddr / 전체 주소지변경, addr : parsing 주소지변경
		}else if (type == 5){
		...
		// "type==6" : interest1,2,3 / 관심사1,2,3변경
		}else if(type == 6){
